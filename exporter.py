"""
- GET THE LYRICS
- ITERATE OVER THE LYRICS UNTIL THE KEY IS FOUND TO BE MATCHING WITH THE LYRICS
- ADD THE MATCHING DICTIONARY KEY VALUE TO THE LYRICS IN A DIFFERENT FORMAT
- DELETE THE MATCHED KEY FROM THE DICTIONARY.
- REPEAT UNTIL ALL KEYS OF THE DICTIONARY ARE EXHAUSTED AND ALL ANNOTATIONS ARE ADDED TO THE LYRICS
